...
- 16 automated tests cover duration/start boundaries, uncertain eligibility, computer-engineering exclusion, multidisciplinary inclusion, query-string job IDs, duplicate handling, history, CSV formula safety, and report generation on successful and empty discovery runs.
...
- No GitHub workflow run has yet been verified. Deployment awaits GitHub authentication.
